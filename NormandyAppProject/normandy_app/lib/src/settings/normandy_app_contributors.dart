...
class ContributorsState extends State<NormandyAppContributors> {
  ...
  Future<void> _getContributors() async {
    ...
    final URL = Uri.parse(
        "https://normandy-backend.azurewebsites.net/api/contributors");
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
            ...
            child: Column(children: [
              Text(
                  "These contributors helped create the Normandy App and web app.",
                        ...
                        return Column(
                          children: [
                            ...
                            ListCard(
                                ...
                                description: allContributors[index]
                                    ["description"],

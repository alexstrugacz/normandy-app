...
class SuperintendentItemDetails extends StatefulWidget {
  final Person person;

  const SuperintendentItemDetails({super.key, required this.person});

  @override
  SuperintendentItemDetailsState createState() => SuperintendentItemDetailsState();
}

class SuperintendentItemDetailsState extends State<SuperintendentItemDetails> {
  bool isFavorite = false;

  @override
  void initState() {
    super.initState();
    loadSuperintendentIsFavorite();
  }

  void toggleFavorite() async {
    await toggleIsFavorite(widget.person.id, 'superintendents');
    setState(() {
      isFavorite = !isFavorite;
    });
  }

  void loadSuperintendentIsFavorite() async {
    bool currentlyIsFavorite = await checkIsFavorite(widget.person.id, 'superintendents');
    setState(() {
